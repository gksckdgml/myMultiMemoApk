package com.example.a805_02.mymultimemoapk.db;
...
public class MemoDatabase {
    ...
    public boolean open() {
		...
		Log.d("알림", "4. MemoDatabase-open - Start");

    	dbHelper = new DatabaseHelper(context);
    	db = dbHelper.getWritableDatabase();

		Log.d("알림", "4. MemoDatabase-open - End");
    	return true;
    }
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public DatabaseHelper(Context context) {
			...
			Log.d("알림", "5. DatabaseHelper - Super - Start");
        }

        public void onCreate(SQLiteDatabase db) {
			Log.d("알림", "5. DatabaseHelper - onCreate - Start");
			...
			Log.d("알림", "5. DatabaseHelper - onCreate - End");
        }
